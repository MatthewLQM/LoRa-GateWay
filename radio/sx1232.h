...
/*!
 * SX1232 FSK General parameters definition
 */
...
extern tSX1232* SX1232;
extern uint8_t SX1232Regs[0x70];

/*!
 * \brief Initializes the SX1232
 */
void SX1232Init( void );

/*!
 * \brief Sets the SX1232 to datasheet default values
 */
void SX1232SetDefaults( void );

/*!
 * \brief Resets the SX1232
 */
void SX1232Reset( void );

/*!
 * \brief Calibrates the Rx chain ( workaround )
 */
void SX1232RxCalibrate( void );

/*!
 * \brief Sets the SX1232 operating mode
 *
...
/*!
 * \brief Gets the SX1232 operating mode
 *
