 ...
 */
const int32_t HoppingFrequencies[] =      //设置跳频
{
    916500000,
    923500000,
    906500000,
...
{
    434000000,        // RFFrequency 收发频率
    20,               // Power 发射功率
    8,                // 带宽SignalBw [0: 7.8kHz, 1: 10.4 kHz, 2: 15.6 kHz, 3: 20.8 kHz, 4: 31.2 kHz,
                      // 5: 41.6 kHz, 6: 62.5 kHz, 7: 125 kHz, 8: 250 kHz, 9: 500 kHz, other: Reserved]
    8,                // 扩频因子SpreadingFactor [6: 64, 7: 128, 8: 256, 9: 512, 10: 1024, 11: 2048, 12: 4096  chips]
    1,                // 循环纠错编码ErrorCoding [1: 4/5, 2: 4/6, 3: 4/7, 4: 4/8]
    true,             // CRC校验CrcOn [0: OFF, 1: ON]
    false,            // 序头模式ImplicitHeaderOn [0: OFF, 1: ON]
    1,                // 接收模式中的single模式开关  0代表continue模式 RxSingleOn [0: Continuous, 1 Single]
    0,                // 跳频开关 FreqHopOn [0: OFF, 1: ON] 
    4,                // 跳频周期 HopPeriod Hops every frequency hopping period symbols 
    100,              // TxPacketTimeout发送超时时间
    100,              // RxPacketTimeout接收超时时间
...
uint32_t SX1276LoRaProcess( void )
{
    ...
    switch( RFLRState )
    {
    case RFLR_STATE_IDLE: result = RF_IDLE;
        break;
