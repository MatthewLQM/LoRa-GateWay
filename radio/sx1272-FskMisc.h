 ...
 */
#ifndef __SX1272_FSK_MISC_H__
#define __SX1272_FSK_MISC_H__
 ...
 *
 * \remark For SX1272 there is no DCC setting. dccValue should be 0
 *         ie: SX1272FskSetDccBw( &SX1272.RegRxBw, 0, 62500 );
 *
 ...
 */
void SX1272FskSetPreambleSize( uint16_t size );
